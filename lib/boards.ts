...
const POST_COLS = 'id, gym_id, board_id, profile_id, content, image_url, image_url2, link_url, link_title, link_image, link_domain, score, comment_count, created_at, party, impressions, profiles!hall_posts_profile_id_fkey(username, avatar_url), gyms!hall_posts_gym_id_fkey(city_name, state)'
