...
export const MODELS_3D: Model3D[] = [
  ...
  { id: 'soldier_boy',  name: 'Sgt. Stars',        party: 'republican', model: '/models/soldier_boy.glb', ready: false },
  ...
  { id: 'palestine',      name: 'The Activist',    party: 'democrat', model: '/models/palestine.glb', ready: false },
