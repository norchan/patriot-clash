...
// 3. MESSAGES/DMs ARE NOT A MONETIZABLE SURFACE (Michael 2026-07-26):
//    AdSense/AdMob prohibit ads in private messages, so message views can
//    never earn and must never enter the payable counter. All earn copy
//    talks about posts (profile/boards/halls/reels) only.
