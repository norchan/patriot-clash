// Boxing jabs from guard for each fighter → fighterN_jabR.glb / fighterN_jabL.glb.
// These clips start AND end in the guard pose, so frame 0 doubles as the idle.
import fs from 'fs'
...
const ACTIONS = [[192, 'jabR'], [191, 'jabL']]
...
console.log('JABS COMPLETE:', JSON.stringify(results))
