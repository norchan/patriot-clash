  ...
  return (
    <div className="min-h-screen text-white relative select-none pb-8"
      ...
      <div className="max-w-md mx-auto px-4 flex items-center justify-between text-[13px] font-black">
        <span style={{ color: '#7dd3fc' }}>🔍 LV{sceneIdx % BANK.length + 1} · {scene.label.toUpperCase()}</span>
          ...
          <div className="absolute inset-0 z-20 flex items-center justify-center rounded-xl px-6"
            ...
            <div className="text-center w-full">
              {phase === 'start' && <>
                ...
                <p className="text-white/70 text-sm mt-2">Two pictures, 6 differences — a different set every round, a new scene every level. The differences get smaller and sneakier as the levels climb. Wrong taps cost 5 seconds.</p>
      ...
      <p className="text-center text-white/40 text-[11px] mt-3">{BANK.length} levels · 20 hand-made versions each — no two rounds alike, harder as you climb.</p>
